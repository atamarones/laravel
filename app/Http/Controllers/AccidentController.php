...
class AccidentController extends Controller
{
    ...
    public function index()
    {
        ...
        $accident = Accident::with(['employee', 'accidentType'])
            ->orderBy('created_at', 'desc')
            ->get();

        return inertia('Accident/Index', [
            'accident' => $accident,
            'can' => [
                'create' => Auth::user()->can('create', Accident::class),
                'edit' => Auth::user()->can('update', Accident::class),
                'delete' => Auth::user()->can('delete', Accident::class),
            ]
        ]);
    }
